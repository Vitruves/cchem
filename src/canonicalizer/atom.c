    ...
    /* Fast path for common two-letter elements */
        ...
        switch (c1) {
            ...
            case 'N': if (c2 == 'e') return ELEM_Ne;
                      ...
                      if (c2 == 'h') return ELEM_Nh; break;
            case 'O': if (c2 == 's') return ELEM_Os;
                      if (c2 == 'g') return ELEM_Og; break;
            ...
            case 'T': if (c2 == 'i') return ELEM_Ti;
                      ...
                      if (c2 == 's') return ELEM_Ts; break;
            case 'X': if (c2 == 'e') return ELEM_Xe; break;
            case 'Y': if (c2 == 'b') return ELEM_Yb; break;
            case 'Z': if (c2 == 'n') return ELEM_Zn;
                      if (c2 == 'r') return ELEM_Zr; break;
        }
    }
